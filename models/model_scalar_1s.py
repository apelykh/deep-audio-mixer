...
#         super().__init__()
#
#         self.conv_b1 = ConvBlock2d(4, 16, (9, 5), dropout_p=0.2, stride=2)
#         self.conv_b2 = ConvBlock2d(16, 32, (7, 5), dropout_p=0.2)
#         self.conv_b3 = ConvBlock2d(32, 48, 5, dropout_p=0.2)
#         self.conv_b4 = ConvBlock2d(48, 64, 5, dropout_p=0.2)
#         self.conv_b5 = ConvBlock2d(64, 128, 3, dropout_p=0.3)
#         self.conv_b6 = ConvBlock2d(128, 128, 3, dropout_p=0.3)
...
class MixingModelScalar1s(nn.Module):
    def __init__(self):
        ...
        self.conv_b1 = ConvBlock2d(4, 16, 3, dropout_p=0.2, stride=2)
...
if __name__ == '__main__':
    ...
    for train_features, gt_features in train_loader:
        model(train_features.float().to(device))
